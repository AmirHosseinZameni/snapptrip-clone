    ...
    <>
      ...
      {isOpen && (
        <div>
          ...
          />
          <div className="fixed inset-0 z-20 left-0 w-screen bg-white p-6 flex flex-col justify-between gap-4 md:absolute md:size-auto md:w-84 md:h-84 md:shadow-2xl rounded-xl isolate">
